			...
			sections = {
				'done': {
					events: {
						onopen: [
							function () {
								gtag('config', 'G-PE42Y7DD93', { 'page_path': '/#done' });
							},
						],
					},
				},
				'icomply': {
					events: {
						onopen: [
							function () {
								gtag('config', 'G-PE42Y7DD93', { 'page_path': '/icomply' });
							},
						],
					},
				},
				'kyc': {
					events: {
						onopen: [
							function () {
								gtag('config', 'G-PE42Y7DD93', { 'page_path': '/#kyc' });
							},
						],
					},
				},
				'home': {
					events: {
						onopen: [
							function () {
								gtag('config', 'G-PE42Y7DD93', { 'page_path': '/' });
							},
						],
					},
				},
